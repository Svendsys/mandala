...
pub(in crate::application::app) fn apply_set_edge_anchor(from: &str, to: &str, rc: &mut RebuildContext<'_>) {
    apply_with_rebuild(rc, |doc| {
        crate::application::console::commands::anchor::apply_anchor_to_selection(doc, Some(from), Some(to))
    });
}
...
/// full rebuild.
pub(in crate::application::app) fn apply_set_edge_body_glyph(preset: &str, rc: &mut RebuildContext<'_>) {
    apply_with_rebuild(rc, |doc| {
...
/// change → full rebuild.
pub(in crate::application::app) fn apply_set_edge_cap(from: &str, to: &str, rc: &mut RebuildContext<'_>) {
    apply_with_rebuild(rc, |doc| {
        crate::application::console::commands::cap::apply_cap_to_selection(doc, Some(from), Some(to))
    });
}
...
/// change → full rebuild.
pub(in crate::application::app) fn apply_set_edge_type(edge_type: &str, rc: &mut RebuildContext<'_>) {
    apply_with_rebuild(rc, |doc| {
...
/// rebuild.
pub(in crate::application::app) fn apply_set_edge_display_mode(mode: &str, rc: &mut RebuildContext<'_>) {
    apply_with_rebuild(rc, |doc| {
        crate::application::console::commands::edge::apply_edge_display_mode_to_selection(doc, mode)
    });
}
...
pub(in crate::application::app) fn apply_reset_edge(kind: &str, rc: &mut RebuildContext<'_>) {
    apply_with_rebuild(rc, |doc| {
...
pub(in crate::application::app) fn apply_set_edge_label_text(text: &str, rc: &mut RebuildContext<'_>) {
    apply_with_rebuild(rc, |doc| {
...
pub(in crate::application::app) fn apply_set_edge_label_position(
    ...
    apply_with_rebuild(rc, |doc| {
        crate::application::console::commands::label::apply_label_position_to_selection(doc, position)
    });
}
